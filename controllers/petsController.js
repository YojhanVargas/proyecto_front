...
function createPetCard(pet, container) {
    ...
    petCard.innerHTML = `
        ...
        <div class="pet-info">
            ...
            <p>${pet.description}</p>
            <a href="#" class="contact-btn" data-contact="${pet.sellerContact}">Contactar</a>
        </div>
    `;
...
function handleContactClick(event) {
    if (event.target.classList.contains('contact-btn')) {
        ...
        const isLoggedIn = localStorage.getItem('isLoggedIn') === 'true'; // Cambia esto según tu lógica de autenticación
        ...
        if (isLoggedIn) {
            ...
            Swal.fire({
                title: '¡Atención!',
                text: 'Debes iniciar sesión para contactar al refugio.',
                icon: 'warning',
                confirmButtonText: 'Iniciar sesión',
                showCloseButton: true, // Muestra el botón de cierre
                closeButtonHtml: '×', // Personaliza el símbolo del botón de cierre
                customClass: {
